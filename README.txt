...
3- Cliquez gauche sur l'icône de WampServer en bas à gauche de l'écran -> Apache -> httpd.conf.
4- Cherchez la ligne "AllowOverride none", changez-la en => "AllowOverride All" ; sauvegardez.
5- Cliquez gauche sur l'icône de WampServer en bas à gauche de l'écran -> VirtualHost -> Gestion VirtualHost.
